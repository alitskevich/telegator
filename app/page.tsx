...
export default async function DashboardPage() {
  /**
   * §8.6 L847 gives `viewer` "Read all pages" — a grant to a role, not to the
   * public, and §8.6 L877 allows no code path that skips authorisation. This
