...
/**
 * §8.3 L802 — the Messages page.
 *
 * §8.2 L779 spells the tab as `?status=`, so it is a URL and not component
...
export default async function MessagesPage({
  ...
  // §8.2 L779's example is `?status=topublish`, which is also the tab an
  ...
  /**
   * §8.4 L814 — soft, and `editor`. §8.3 L802's row does not list delete;
