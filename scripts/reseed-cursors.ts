...
/**
 * §9.5 step 5 (L975) — re-seed `lastItemId` so AWS resumes where Firebase
 ...
 * their own cursors underneath, so step 6 (L976) enables the AWS schedule
 * against a stale value and re-scrapes the gap — which is L978's double-post.
