...
/**
 * §8.3 L800 — "Stat cards (items scraped / analysed / skipped 24 h, messages
 ...
 *
 * Never `0`. §8.5 L833's "Errors" card is the reason: zero dead letters is a
  ...
  return (
    <>
      ...
      <section className="stat-cards">
        ...
        {/* §8.5 L831 — the split is the informative part. A bare total says
