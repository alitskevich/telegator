...
describe("Dashboard — §8.3 L800", () => {
  ...
  /**
   * §8.5 L831 splits skips by reason, and the split is the informative part: a
...
/**
 * §8.5 L833's "Errors" card is a claim about pipeline health, so the one thing
