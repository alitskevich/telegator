...
/**
 * §9.2 L864 — "Resource names are environment-prefixed" — without saying what
 * the prefix looks like. Recorded scheme: `telegator-{env}-{resource}`.
 *
 * §7.2 L631, §7.3 L644–646 and §7.5 L687–691 all write bare names like
 * `telegator-messages`. Those are read as the *unprefixed base*: the two
 * environments are separate AWS accounts (§9.2 L864), so the prefix is not
...
export interface NameOptions {
   ...
   * Standard one; §7.3 L645–646 name the FIFO queues without it.
   */
