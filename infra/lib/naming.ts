...
/**
 * §9.2 L896 — "Resource names are environment-prefixed" — without saying what
 * the prefix looks like. Recorded scheme: `telegator-{env}-{resource}`.
 *
 * §7.2 L633, §7.3 L646–648 and §7.5 L689–693 all write bare names like
 * `telegator-messages`. Those are read as the *unprefixed base*: the two
 * environments are separate AWS accounts (§9.2 L896), so the prefix is not
...
export interface NameOptions {
   ...
   * Standard one; §7.3 L647–648 name the FIFO queues without it.
   */
