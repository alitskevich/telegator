 ...
 * says a post that never merges "leaves no row anywhere", and §8.4 L810 makes
 ...
 * and every template assertion, then fail at runtime on §3.1 L199's source
 * selection and §6 L560's dedup read. A Scan here is always a table scan
