...
describe("cloudWatchMetricReader", () => {
  ...
  /**
   * §8.5 L829-831 asks for a Sum over the `Telegator` namespace. Statistic and
  ...
  describe("sumByDimension", () => {
    /**
     * §8.5 L831 — "`ItemsSkipped` Sum by `Reason`". CloudWatch cannot enumerate
...
describe("sqsQueueDepthReader", () => {
  ...
  /**
   * §8.5 L833 makes the DLQ depths the "Errors" card. A missing attribute must
