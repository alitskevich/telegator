      ...
      new GetMetricDataCommand({
        ...
        MetricDataQueries: dimensionSets.map((Dimensions, index) => ({
          ...
          MetricStat: {
            ...
            Period: period,
            // §8.5 L829-831 says Sum. `Average` over a counter reads as a rate.
            Stat: "Sum",
          },
          ReturnData: true,
        })),
...
/**
 * A count that is absent or unparseable reads as zero. §8.5 L833 makes DLQ depth
...
/**
 * §8.5 L835 — the category chart, over 7 days of analyze logs.
 *
