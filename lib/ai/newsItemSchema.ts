...
/**
 * The classification response schema, §5.2 L445–457.
 *
 * Derived from the payload's `AiFieldsSchema` rather than redeclaring nine
 * fields: that module already owns their types, L445's required/optional split
 * and §11.2's 220-character cap, and two hand-maintained definitions drift.
 *
 * Only `category` differs, and the difference is meaningful. §5.2 L453
 * constrains the model to §5.4's enum, while §2.2 L138 lets the item payload
 ...
 *
 * The `.describe()` calls are not documentation. §5.2 L447–457's Description
...
export const NewsItemSchema = AiFieldsSchema.extend({
   ...
   * rejected anything over, and §3.2 L251 sent a *permanent* failure down the
...
/**
 * The JSON Schema sent as `output_config.format.schema` (§5.2 L427).
 *
