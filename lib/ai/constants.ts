 ...
 * `effort` and the structured-output `format`, so §5.2 L426-435's request body
...
/**
 * R2, re-slugged by R50 — the classifier tier §11.1 L1044 decided.
 *
...
/**
 * §5.2 L429 — `output_config.effort`, which L461 says replaces the removed
