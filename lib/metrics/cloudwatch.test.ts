...
describe("createCloudWatchMetrics", () => {
  test("sends one datum under the §7.7 L726 namespace for a single count", async () => {
...
/**
 * §1.3 L69 — a post that never merges "leaves no row anywhere". A lost metric
...
/**
 * §7.7 L741 refuses a per-category metric: "Thirty-five category dimensions
