...
describe("the metric catalogue", () => {
  test("is the twelve names §7.7 L729-739 lists, then R50's two", () => {
  ...
  test("publishes under the namespace §7.7 L726 names", () => {
...
describe("recordingMetrics", () => {
  ...
  /**
   * §3.2 L257-258 routes drops by reason, and §8.5 L831 charts items skipped
