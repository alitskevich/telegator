 ...
 *
 * *Reconciliation.* §8.3 L801 specifies only the cross-column search, and §8.1
 * L766 records that with the offline layer deleted "filtering and sorting become
 ...
 * the server sent carries meaning of its own — §8.5 L832 reads `status-index`
