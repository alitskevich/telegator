...
describe("createSqsQueueProducer", () => {
   ...
   * arrays, and §3.1 L231 / AC-1.5 L236 need that visible as a value. A throw
  ...
  test("chunks at the 10-entry API limit (§3.1 L227)", async () => {
    sqsMock
  ...
  /** §7.3 L650 — telegator-analyze is Standard, and SQS rejects the FIFO keys there. */
