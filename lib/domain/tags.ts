 ...
 * §3.2 L260 defines the merge as "comma-split, deduplicated, comma-joined".
 */
 ...
 *
 * First-seen order is the load-bearing part. §3.3 L286 merges as
 ...
 * folding would discard the stored form of a tag; §3.4 L342 lowercases when it
