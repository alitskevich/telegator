...
describe("startSession", () => {
  ...
  /**
   * §8.6 L844 puts the dashboard behind a Cognito hosted UI, so the cookie must
...
describe("requireRole — the three gates of §8.4 L823 and §8.6 L875", () => {
   ...
   * carries `admin`; only the directory says otherwise. §8.6 L875 — "a disabled
  ...
  /**
   * §8.6 L877 — "The source's API handler bypasses authentication entirely when
