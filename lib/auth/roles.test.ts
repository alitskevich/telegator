...
describe("ROLE_GROUPS", () => {
  /**
   * §8.6 L840 — "one group per role", and the table at L842-846 lists exactly
...
describe("hasRole", () => {
  /**
   * §8.6 L844-845 — the grants are cumulative: `editor` is viewer "+", `admin`
  ...
  /**
   * §8.4 L819 — "every action ... re-checks the caller's role server-side". An
