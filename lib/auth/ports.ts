...
/**
 * The boundaries of §8.6 L840's Cognito hosted UI. Each is an interface with an
...
/** §8.2 L775 — `api/auth/[...]/route.ts`, the authorization-code exchange. */
...
/**
 * §8.6 L871 — "a new user is created **disabled** ... a disabled user is
