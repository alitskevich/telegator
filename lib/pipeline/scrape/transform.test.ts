...
describe("transformPost — id (§3.1 L224)", () => {
...
describe("transformPost — teaser stripping (§3.1 L224)", () => {
...
describe("transformPost — kind (§2.2 L140, §3.1 L224)", () => {
  ...
  /** §3.1 L224 names `forward` before `empty`; the order is normative. */
