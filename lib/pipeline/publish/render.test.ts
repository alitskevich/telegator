...
/** The `🔘 ` prefix and ` - @mention` suffix §3.4 L326 fixes around every block. */
...
describe("renderMember", () => {
  test("emits the §3.4 L326 shape: 🔘 prefix, content, and the @channel link", () => {
  ...
  test("§3.4 L323 — replaces a resolved [text](#N) token with an anchor", () => {
  ...
  /**
   * §3.4 L351 sends with `parse_mode: html`, so raw `<` and `&` in a summary
...
describe("renderMembers", () => {
  test("§3.4 L323 — orders members by ts ascending", () => {
  ...
  test("§3.4 L323 — renders only the first 12 when 20 members are present", () => {
