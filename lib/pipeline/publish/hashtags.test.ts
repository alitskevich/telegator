...
/** The two tags §3.4 L342 always contributes, on an otherwise empty source. */
...
describe("toHashtag", () => {
  ...
  // §3.4 L342 lists exactly these eight characters as removed.
   ...
   * `date_`/`ts_` tokens of §3.4 L342 readable after normalisation.
   */
...
describe("buildHashtagLine", () => {
  ...
  test("emits the four source fields in the order §3.4 L342 lists them", () => {
   ...
   * of §3.4 L348 by rewriting a message that had not changed.
   */
...
describe("title words", () => {
   ...
   * normalised to `_` by §3.4 L342's mapping, it does not split the word.
   */
