...
describe("fakeFetcher", () => {
   ...
   * a convenience: §3.1 L220 turns an empty fetch into a zeroYieldRuns
   * increment, which is how §4.1 L378's staleness alarm ever fires. A thrown
...
describe("fakeBot", () => {
  ...
  /**
   * §4.2 L386 — "Failures return HTTP 200 with `{ok: false, description}` —
