...
/**
 * Everything `app/page.tsx` renders (§8.3 L800), gathered in one place so the
...
export interface Overview {
  ...
  /** §8.5 L833. `null` when any DLQ went unread — see `errorCount`. */
 ...
 *
 * The strip and the status chart both want every depth, and §8.5 L838's cache
