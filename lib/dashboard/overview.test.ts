...
describe("loadOverview — §8.3 L800 and §8.5", () => {
  ...
  /** §8.5 L833 — "Sum of all DLQ depths". */
  ...
  /** §8.3 L800 — "queue-depth strip", every queue and its DLQ. */
   ...
   * changed between them — and §8.5 L838's cache covers CloudWatch only.
   */
...
describe("a queue the dashboard cannot read", () => {
  ...
  /** §8.5 L833's card. A zero here would read as "the pipeline is fine". */
