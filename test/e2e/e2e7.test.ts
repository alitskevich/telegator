...
/**
 * E2E-7 (§10.2 L1002) — "An OpenRouter outage sends every in-flight item to the
 ...
 * not this code. What is ours is the decision §3.2 L262 makes — a provider error
...
describe("E2E-7 — during the outage", () => {
  ...
  /**
   * The load-bearing assertion. §3.2 L262 makes a provider error a retry, and
   ...
   * reported them as filtered on purpose — and §7.7 L724 makes CloudWatch the
