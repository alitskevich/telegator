...
describe("every page authorises (§8.6 L877)", () => {
  ...
  /**
   * §8.6 L847 gives `viewer` "Read all pages" — which is a grant to a role, not
   ...
   * hiding a page §8.6 L847 says viewers read — so the minimum is pinned too.
   */
  ...
  /**
   * §8.2 L779's Cognito callbacks are the one route that must stay reachable
