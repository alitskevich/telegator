...
/**
 * A static import graph, used to enforce §8.2 L777 transitively.
 *
 ...
 * pipeline *type* — a restriction §8.2 L777 does not ask for.
 */
 ...
 * L777 boundary, and forbidding the form is `test/importExtensions.test.ts`'s
 * job, not this one's.
 */
