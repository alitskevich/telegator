...
describe("the §8.2 L792 boundary", () => {
  /**
  ...
  /**
   * §9.3 L910 deploys this on Amplify. A CDK import would pull the whole
  ...
  /**
   * §8.1 L764-768 is a deletion, and it is the point of the section: the
