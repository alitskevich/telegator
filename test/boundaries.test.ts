...
describe("the §8.2 L788 boundary", () => {
  /**
  ...
  /**
   * §9.3 L906 deploys this on Amplify. A CDK import would pull the whole
  ...
  /**
   * §8.1 L760-764 is a deletion, and it is the point of the section: the
