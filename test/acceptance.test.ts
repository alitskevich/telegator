...
/**
 * §10.1 — "§3.1–3.4 are the functional test suite".
 *
 ...
 *
 * R18: §10.1 L990 proposes DynamoDB Local and ElasticMQ, neither of which runs
...
/**
 * The four criteria design §11 ADDS, which carry no id of their own.
 *
 * The audit below is bidirectional over the ids `docs/telegator.md`
 ...
 * check that `docs/telegator.md` does not declare.
 */
...
function acceptanceCriteria(): string[] {
  const spec = readFileSync(join(repoRoot, "docs/telegator.md"), "utf8");
...
describe("§10.1 — every stage criterion is named by a test", () => {
  /**
   ...
   * is either a typo — AC-3.99 for AC-3.9 asserts something no criterion asked
