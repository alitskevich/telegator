 ...
 * Every page of §8.2 L775-780 returned one to a signed-out browser — including
...
describe("authorized()", () => {
  ...
  /**
   * §8.6 L844 puts the console behind the hosted UI. A signed-out visitor has
  ...
  /**
   * §8.6 L875: "a disabled user is rejected at every action". They are signed
