 ...
 * Every page of §8.2 L771-776 returned one to a signed-out browser — including
...
describe("authorized()", () => {
  ...
  /**
   * §8.6 L840 puts the console behind the hosted UI. A signed-out visitor has
  ...
  /**
   * §8.6 L871: "a disabled user is rejected at every action". They are signed
